...
function loadRabbitSprites()
	for i = 1 , 4 do
		...
		--BUNNY V2
		sprite.add(bunnySets[i],"lookAroundS",	43 + 51*0 +0  ,12		,10*80,-1)
		...
		sprite.add(bunnySets[i],"lookAroundSW",	43 + 51*1 +0  ,12		,10*80,-1)
		...
		sprite.add(bunnySets[i],"lookAroundN",	43 + 51*2 +0  ,12		,10*80,-1)
		...
		sprite.add(bunnySets[i],"lookAroundNW",	43 + 51*3 +0  ,12		,10*80,-1)
		...
		sprite.add(bunnySets[i],"lookAroundNE",	43 + 51*4 +0  ,12		,10*80,-1)
		...
		sprite.add(bunnySets[i],"lookAroundSE",	43 + 51*5 +0  ,12		,10*80,-1)

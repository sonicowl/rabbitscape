...
function scene:createScene( event )
	...
	gameEngine.createNewObject({ terrainCost = 0 , maxMembers = -1, isDynamic = true , appearingWeight = 0 , isPlaceable = false, isWalkable = true , isExit=true , isFakeExit=false, canPutObjects = false , tag="endCell" ,img="grid2.png", imgW=stdImgW*1.3, imgH=stdImgH*1.3, isAnimated = true})

...
--[[
	...
	gameEngine.createNewObject({ terrainCost = 0 , maxMembers = -1, isDynamic = false , appearingWeight = 0 , isPlaceable = false, isWalkable = true , isExit=true , isFakeExit=false, canPutObjects = false , tag="endCell" ,img="gridRed.png", imgW=stdImgW*1.4, imgH=stdImgH*1.2, alpha = 0.5 })
